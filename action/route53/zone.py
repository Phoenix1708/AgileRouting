import copy
from utilities.exception import TooManyRecordsException
...
class Zone(object):
    """
    A Route53 Zone model which contains actions for a Route53 zone.

    :ivar route53connection: A
    :class:`action.route53.connection.Route53Connection` connection
